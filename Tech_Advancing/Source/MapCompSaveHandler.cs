...
namespace TechAdvancing
{
    public class MapCompSaveHandler : MapComponent
    {
        ...
        public override void ExposeData()
        {
            ...
            LogOutput.WriteLogMessage(Errorlevel.Information, "isPplDictSaved:" + isPplDictSaved.ToString());
            ...
            if (ColonyPeople != null)
            {
                ...
                if (isPplDictSaved == 1 && ColonyPeople.Count > 0)
                {
                    LogOutput.WriteLogMessage(Errorlevel.Information, "ColonyPeople: " + ColonyPeople.ToStringFullContents());
